    ...
    <div className="stack" style={{ gap: 24 }}>
      <div className="form-grid">
        <Card className="settings-card">
          <div className="stack">
            <span className="icon-tile"><Plane /></span>
            <div>
            ...
            >
              ...
              <Input label="Destino (IATA)" name="destination" placeholder="LIS" maxLength={3} required />
              <Input label="Ida" name="outboundDate" type="date" min={today} required />
              <Input label="Volta" name="inboundDate" type="date" min={today} />
              <Input label="Adultos" name="adults" type="number" min={1} max={9} defaultValue={1} required />
              ...
              <Button className="full" type="submit" loading={busy === "flights"}>
                Comparar passagens <ArrowUpRight size={16} />
              </Button>
            </form>
          </div>
        </Card>
        ...
        <Card className="settings-card">
          <div className="stack">
            <span className="icon-tile"><BedDouble /></span>
            <div>
              <h2>Hospedagem</h2>
            ...
            >
              ...
              <Input label="Adultos" name="adults" type="number" min={1} max={20} defaultValue={2} required />
              <Input label="Quartos" name="rooms" type="number" min={1} max={10} defaultValue={1} required />
              <Button className="full" type="submit" loading={busy === "hotels"}>
                Buscar hospedagem <ArrowUpRight size={16} />
              </Button>
            </form>
          </div>
        </Card>
